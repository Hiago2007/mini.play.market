...
void game(int & true_false, int & what_1, int & gde, int & what) {
...
void ball_right_2(int& left_or_right, int& obman_y, int& obman_x, int& or_or, int& i, int& i1, int& i2, int& i_1, int& i1_1, int& i2_1, int & x_y1, int& perevirka)
{
...
void ball_left_2(int& left_or_right, int& obman_y, int& obman_x, int& or_or, int& i, int& i1, int& i2, int& i_1, int& i1_1, int& i2_1, int& x_y1, int& perevirka, int & x_y) {
	left_or_right = 2;
	if (obman_y == 1 or obman_y == 13 or obman_x == 23 or obman_x == 2) {
...
void left_ball_1(int & i, int& i1, int& i2, int& verh) {
	GetKEY();
	if (KEY[38])
	{
...
void right_ball_1(int& i_1, int& i1_1, int& i2_1, int& verh) {
	GetKEY();
	if (KEY[38])
	{
...
void all() {
	...
	if (what == 1) {
		...
		int what_1 = 1;
		int true_false = 1;
		game(true_false, what_1, gde, what);
	...
	if (what == 2) {
		...
		while (true_false_1 != 0) {
			...
			game_player(gde, what_1, regim, true_false_1);
			...
			while (anti != 1)
			{
				...
				if (mozno == 0) {
					if (perevirka == 1) {
						...
						ball_right_2(left_or_right, obman_y, obman_x, or_or, i, i1, i2, i_1, i1_1, i2_1, x_y1, perevirka);
						
						
					}

					else if (perevirka == 2) {
						ball_left_2(left_or_right, obman_y, obman_x, or_or, i, i1, i2, i_1, i1_1, i2_1, x_y1, perevirka, x_y);
					}
					...
					//клавиша верх
					if (left_or_right == 2) {
						left_ball_1(i, i1, i2, verh);
					}
				}

				if (left_or_right == 1) {
					right_ball_1(i_1, i1_1,i2_1, verh);
